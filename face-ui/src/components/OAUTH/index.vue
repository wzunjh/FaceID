      ...
      <el-col :span="24">
        <el-card>
          <el-header style="background-color: #ffffff">
            <el-button @click="handleSave()" icon="el-icon-circle-plus-outline">添加应用</el-button>
          </el-header>
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column label="操作" width="230">
              <template v-slot:default="scope">
                ...
                <el-popconfirm :title="'确认删除' + scope.row.name + '应用吗?'" @confirm="handleDelete(scope.$index, scope.row)">
